...
load_file = sys.path.append("users/austins/Desktop/PHYS_4840/MIST_v1.2_feh_m1.75_afe_p0.0_vvcrit0.4_HST_WFPC2.iso.cmd")
filename = sys.path.append("users/austins/Desktop/PHYS_4840/NGC6341.dat")
