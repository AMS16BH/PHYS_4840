...
print("100 Iterations_")
print(f"Loop Time: ", "%.5f"%loop_time,"secs")
print(f"Numpy Time: ", "%.5f"%numpy_time,"secs")
print("___________")
print("1000 Iterations_")
loop_time = timeit.timeit("sum([x**2 for x in range(100000)])", setup=setup_code, number=1000)
numpy_time = timeit.timeit("np.sum(my_array**2)", setup=setup_code, number=1000)
