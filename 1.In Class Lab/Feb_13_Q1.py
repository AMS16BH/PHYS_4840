...
import numpy as np 
import sys
sys.path.append('/d/users/austins/Desktop/PHYS_4840/')
...
print(lib.distance_modulus(8630))

##### Q2 ######

load_file = '/d/users/austins/Desktop/PHYS_4840/DATA/MIST_v1.2_feh_m1.75_afe_p0.0_vvcrit0.4_HST_WFPC2.iso.cmd'
...
filename = '/d/users/austins/Desktop/PHYS_4840/DATA/NGC6341.dat'
...
axes[0].plot(cleaned_color, cleaned_magnitude+lib.distance_modulus(8630), 'go', markersize=2, linestyle='-')
axes[0].invert_yaxis()
...
axes[2].plot(cleaned_color, cleaned_magnitude+lib.distance_modulus(8630), 'go', markersize=2, linestyle='-')
axes[2].invert_yaxis()
